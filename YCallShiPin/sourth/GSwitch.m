...
- (void)setupUI
{
    ...
    UILabel *offLable = [[UILabel alloc] initWithFrame:CGRectMake(0, 0,self.frame.size.width/2, self.frame.size.height-kHorizontalAdjustment)];
   // offLable.text = @"on";
    offLable.textColor = [UIColor whiteColor];
    offLable.font = [UIFont systemFontOfSize:17 * kwidthScale];
    offLable.textAlignment = 1;
    [self addSubview:offLable];
    
    UILabel *onLable = [[UILabel alloc] initWithFrame:CGRectMake(self.frame.size.width/2, 0,self.frame.size.width/2, self.frame.size.height-kHorizontalAdjustment)];
    //onLable.text = @"off";
    onLable.textColor = [UIColor whiteColor];
    onLable.font = [UIFont systemFontOfSize:17 * kwidthScale];
    onLable.textAlignment = 1;
    [self addSubview:onLable];
